...
public class LocalServices {
    ...
    static WifiP2pServiceInfo createRendererService() {
        ...
        return WifiP2pUpnpServiceInfo.newInstance("6859dede-8574-59ab-9332-123456789011",
                "urn:schemas-upnp-org:device:MediaRenderer:1", services
        );
    }
    ...
    static WifiP2pServiceInfo createIppService() {
        ...
        return WifiP2pDnsSdServiceInfo.newInstance("MyPrinter", "_ipp._tcp", txtRecord);
    }
    ...
    static WifiP2pServiceInfo createAfpService() {
        return WifiP2pDnsSdServiceInfo.newInstance("Example", "_afpovertcp._tcp", null);
    }
}
