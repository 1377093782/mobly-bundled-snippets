...
public class WifiAwareManagerSnippet implements Snippet {
    ...
    public static DiscoverySession mDiscoverySession;
    public static PeerHandle mPeerHandle;
     ...
     */
    @AsyncRpc(description = "Create a Wi-Fi Aware subscribe discovery session and handle " +
            "callbacks.")
    ...
    public void sendAwareMessage(int messageId, String message) throws WifiAwareManagerSnippetException {
    ...
    public void closeDiscoverSession() {
        if (mDiscoverySession != null) {
    ...
    public void closeWifiAwareSession() {
        if (mWifiAwareSession != null) {
            mWifiAwareSession.close();
            mWifiAwareSession = null;
        }
