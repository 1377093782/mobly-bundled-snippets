...
public class WifiAwareJsonDeserializer {
    ...
    public static SubscribeConfig jsonToSubscribeConfig(JSONObject jsonObject) throws JSONException {
        ...
        if (jsonObject.has(SERVICE_SPECIFIC_INFO)) {
            byte[] serviceSpecificInfo = jsonObject.getString(SERVICE_SPECIFIC_INFO)
     ...
     *                                  tests/hostsidetests/multidevices/test/aware/constants.py
     */
    public static WifiAwareNetworkSpecifier jsonToWifiAwareNetworkSpecifier(JSONObject jsonObject) throws JSONException {

        PeerHandle peerHandle = WifiAwareManagerSnippet.mPeerHandle;
        DiscoverySession wifiAwareDiscoverySession = WifiAwareManagerSnippet.mDiscoverySession;
